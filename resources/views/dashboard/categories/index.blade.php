...
@section('container')
    ...
    <div class="table-responsive small col-lg-4">
        <a href="/dashboard/categories/create" class="btn btn-success"><i class="bi bi-pencil-fill"></i> Create
            categories</a>
            ...
            @foreach ($categories as $index => $category)
                <tr>
                    ...
                    <td>
                        ...
                        <a class="text-white border border-warning bg-warning p-1 rounded px-2"
                           href="/dashboard/categories/{{ $category->slug }}/edit"><i class="bi bi-pencil-fill"></i></a>
                        <form action="/dashboard/categories/{{ $category->slug }}" method="post" class="d-inline">
                            @method('delete')
                            @csrf
                            <button class="text-white border-0 border-danger bg-danger p-1 rounded px-2"
