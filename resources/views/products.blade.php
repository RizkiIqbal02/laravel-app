        ...
        <section class="py-5 text-center container">
            <div class="row py-lg-5">
                <div class="col-lg-6 col-md-8 mx-auto">
                    ...
                    <p class="lead text-body-secondary">Explore here to discover market prices, stock availability, and
                        make the process of categorizing and grouping products easier and more organized. Enjoy a more
                        pleasant and responsive shopping experience as you browse through your desired items.</p>
                </div>
            </div>
        </section>
